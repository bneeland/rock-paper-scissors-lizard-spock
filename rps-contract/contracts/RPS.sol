...
contract RPS{
    ...
    function play(Move _c2) payable {
        require(c2==Move.Null, "Error: You have already played."); // J2 has not played yet.
        require(msg.value==stake, "Error: You have not paid the stake."); // J2 has paid the stake.
        require(msg.sender==j2, "Error: You are not assigned as player 2 for this round."); // Only j2 can call this function.
    ...
    function solve(Move _c1, uint256 _salt) {
        require(c2!=Move.Null, "Error: Player 2 has not played yet."); // J2 must have played.
        require(msg.sender==j1, "Error: You are not assigned as player 1 for this round."); // J1 can call this.
        require(keccak256(_c1,_salt)==c1Hash, "Error: This is not the move you committed to when starting this round."); // Verify the value is the commited one.
...
// c1Hash with _c = 1 (for Move.Rock) and _salt = 123
// c1Hash = 0x48b0517dc17384a96f0dde4440cc4101d2d7f669f62c2a4395c27d7a2e791474

  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Rock Paper Scissors Lizard Spock app" />
      </Head>
      <div className="my-32">
        <h1 className="text-4xl font-bold text-center text-slate-900 my-6">Rock Paper Scissors Lizard Spock</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-12 mb-16">
        <Link href="/new">
          <a className="block p-8 rounded-xl bg-gradient-to-r from-purple-800 to-fuchsia-600 hover:bg-gradient-to-r hover:from-purple-900 hover:to-fuchsia-700 hover:drop-shadow-lg">
            ...
            <p className="text-lg text-white my-3">Stake some ETH and challenge someone to a round</p>
          </a>
        </Link>
        <Link href="/join">
          <a className="block p-8 rounded-xl bg-gradient-to-r from-purple-800 to-fuchsia-600 hover:bg-gradient-to-r hover:from-purple-900 hover:to-fuchsia-700 hover:drop-shadow-lg">
